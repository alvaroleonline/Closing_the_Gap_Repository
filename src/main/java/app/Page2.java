...
public class Page2 implements Handler {
    ...
    public void handle(Context context) throws Exception {
        ...
        html = html + "<p> This website demonstrates progress on the socioeconomic outcomes of the <a href='https://www.closingthegap.gov.au/'> 2020 National Agreement on Closing the Gap for Indigenous Australians</a>. ";
        ...
        html = html + "<hr class='small'>" + "<div class='row4'>" + "<div class='col104'><b id='blue900'>Official target: </b></div><div class='col204'><p>Close the Gap in life expectancy within a generation, by 2031.</p></div>" + "</div>";
        html = html + "<hr class='small'>" + "<div class='row4'>" + "<div class='col104'><b id='blue900'>How this site measures progress:</b></div><div class='col204'><p>Number of Indigenous people aged 65 or over, as a proportion of total Indigenous population.</p></div>" + "</div>";
        ...
        html = html + "<hr class='small'>" + "<div class='row4'>" + "<div class='col104'><b id='blue900'>Official target: </b></div><div class='col204'><p>By 2031, increase the proportion of Aboriginal and Torres Strait Islander people (age 20-24) attaining year 12 or equivalent qualification to 96 per cent.</p></div>" + "</div>";
        html = html + "<hr class='small'>" + "<div class='row4'>" + "<div class='col104'><b id='blue900'>How this site measures progress: </b></div><div class='col204'><p>Number of Indigenous people aged 15 or over who have completed year 12.</p></div>" + "</div>";
        html = html + "<hr class='small'>";
        html = html + "</div>";
        ...
        html = html + "<hr class='small'>" + "<div class='row4'>" + "<div class='col104'><b id='blue900'>Official target: </b></div><div class='col204'><p>By 2031, increase the proportion of Aboriginal and Torres Strait Islander people aged 25-34 years who have completed a tertiary qualification (Certificate III and above) to 70 per cent.</p></div>" + "</div>";
        html = html + "<hr class='small'>" + "<div class='row4'>" + "<div class='col104'><b id='blue900'>How this site measures progress: </b></div><div class='col204'><p>Number of Indigenous people aged 15 or over who have completed tertiary qualifications equivalent to an Advanced Diploma and above.</p></div>" + "</div>";
        html = html + "<hr class='small'>";
        html = html + "</div>";
        ...
        html = html + "<hr class='small'>" + "<div class='row4'>" + "<div class='col104'><b id='blue900'>Official target: </b></div><div class='col204'><p>By 2031, increase the proportion of Aboriginal and Torres Strait Islander people aged 25-64 who are employed to 62 per cent.</p></div>" + "</div>";
        html = html + "<hr class='small'>" + "<div class='row4'>" + "<div class='col104'><b id='blue900'>How this site measures progress: </b></div><div class='col204'><p>Number of Indigenous people aged 15 or over who are employed.</p></div>" + "</div>";
        html = html + "<hr class='small'>";
        html = html + "</div>";
        ...
        html = html + "<h2>Gap Score</h2>";
        html = html + "<p>The latter two pages of the site (<i>Measuring the Gap</i> and <i>Compare LGAs</i>) utilise a measure called Gap Score. This measure looks at the proportion of Indigenous population in an LGA who have reached the target for an outcome, and compares it against the national average for the non-Indigenous population for the same outcome. This difference is then converted into a rating from 0 to 100, where 100 indicates the Indigenous population have met or exceeded that national average, and a 0 indicates that none of the local Indigenous population meet the measurement requirements.</p><br>";

...
public class Page2 implements Handler {
    ...
    public void handle(Context context) throws Exception {
        ...
        html = html + "<p>The latter two pages of the site (<i>Measuring the Gap</i> and <i>Compare LGAs</i>) utilise a measure called the Gap Score. This measure looks at the proportion of Indigenous population in an LGA who have reached the target for an outcome, and compares it against the national average for the non-Indigenous population for the same outcome. This difference is then converted into a rating from 0 to 100, where 100 indicates the Indigenous population have met or exceeded that national average, and a 0 indicates that none of the local Indigenous population meet the measurement requirements.</p><br>";

...
public class Index implements Handler {
    ...
    public void handle(Context context) throws Exception {
        ...
        html = html + "<hr class='in'>" + "<a href='https://www.naccho.org.au'><h2 class='resourcelink'><p>Category: Heath</p>National Aboriginal Community Controlled Health Organisation</h2></a>";
        html = html + "<hr class='in'>" + "<a href='https://firstnationsmedia.org.au'><h2 class='resourcelink'><p>Category: Media</p>First Nations Media Australia</h2></a>";
        html = html + "<hr class='in'>" + "<a href='https://humanrights.gov.au/'><h2 class='resourcelink'><p>Category: Statutory Organisation</p>National Congress of Australia's First Peoples</h2></a>";
        html = html + "<hr class='in'>" + "<a href='https://aiatsis.gov.au/'><h2 class='resourcelink'><p>Category: Media</p>AIATSIS</h2></a>";
        html = html + "</div>";
